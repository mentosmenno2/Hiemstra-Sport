<?php
	...
	if (isset($_POST["sex"]) && isset($_POST["firstName"]) && isset($_POST["middleName"]) && isset($_POST["lastName"]) && isset($_POST["street"]) && isset($_POST["homeNumber"]) && isset($_POST["town"]) && isset($_POST["phone"]) && isset($_POST["sports"])) 
		{
			...
			require 'functions/editprofileform/checkEditProfileFormContainsNoEmptyData.php';
		}	
